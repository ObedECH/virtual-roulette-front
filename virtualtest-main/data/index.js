$(function () {
	...
	var getWinnerHtml = function(data) {
		var html = `
			<strong>
			<p class="data-name">
			<strong style="color: #c26a0b;">Nombre:</strong>
			 ${data.name}</p><br>
			<p class="data-general">
			<strong style="color: #c26a0b;">Región:</strong>			
			 ${data.region}</p><br>
			<p class="data-general">
			<strong style="color: #c26a0b;">Compañía:</strong>
			 ${data.company}</p><br>
			<p class="data-general">
			<strong style="color: #c26a0b;">Area:</strong>			
			 ${data.area}</p><br>
			<p class="data-general">
			<strong style="color: #c26a0b;">Premio Id:</strong>			
			 ${data.prize}</p><br>
			<p class="data-general">
			<strong style="color: #c26a0b;">Fecha:</strong>						
